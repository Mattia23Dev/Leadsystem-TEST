...
const Orientatori = () => {
  ...
  return (
    <div className='big-container'>
      <Sidebar />
      <div className={`${isSidebarOpen ? 'orientatori-container' : 'orientatori-container-closed'}`} style={containerStyle}>
...
{modifyOrientatore && (
        ...
        {/*<TopDash hidecerca hideciao exportright />*/}

        {/*<div className='filtraorient' style={{marginTop: '100px'}}>
          <h5 style={{ color: "grey" }}>Filtra per data</h5>
              ...
              {isLoading ?
                ...
                <div id="oftable">
                  ...
                  <table style={{ minWidth: '40%' }} aria-label="simple table" className="table-container">
                    ...
                    <tbody style={{ color: "white", textAlign: 'left', width: '100%' }} className="table-body-container">

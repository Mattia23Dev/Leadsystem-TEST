...
const HomeSuper = ({history}) => {
    ...
    useEffect(() => {
      if (startDate && endDate && new Date(startDate) < new Date(endDate)) {
        ...
        setUsers(filteredLeadUsers);
        setLeadAssegnati(filteredLeadAssegnati);
        setLeadEntrati(filteredLeadEntrati);
        setLeadEntratiWha(filteredLeadEntratiWha);
        setLeadEntratiWo(filteredLeadEntratiWo);
        ...
        console.log(filteredLeadEntratiWha);
        console.log(filteredLeadAssegnati);

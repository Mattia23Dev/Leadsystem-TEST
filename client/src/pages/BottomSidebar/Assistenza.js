      ...
      <div className={`${isSidebarOpen ? 'boost-container' : 'boost-container-closed'}`} style={containerStyle}>
        ...
        <div className='ass'>
          {/* <div className='assistenza'>
                <form onSubmit={handleSubmit} className='form-assistenza'>
                  <div className='form-top'> 
                    <h4>Nome:<font color='#3471CC'> {state.user.name}</font></h4>
                  </div>
                  <div className='form-top'> 
                    <h4>Email:<font color='#3471CC'> {state.user.email}</font></h4>
                  </div>
                  ...
                  <button type="submit" className='assistenza-button'>Invia</button>
                </form>
              </div> */}

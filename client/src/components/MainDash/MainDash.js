...
import icon2 from '../../imgs/Group2.png';
import iconmano from '../../imgs/mano.svg';
...
const MainDash = () => {
  ...
  console.log(hasAccpeptNotification);
...
const handleEnableNotifications = async () => {
  ...
  return (
    <div className={`${isSidebarOpen ? 'MainDash' : 'MainDash-closed'}`} style={containerStyle}>
      {state.user._id == "64ba3df7e1c3aea9bdc02785" ? <button onClick={() => notifyUser('Riceverai notifiche quando ti saranno entrati lead!')}>Notifica</button> : null}
      ...
      <TopDash SETsearch={SETsearch} hideattivi hideexportLeads generatePdf={generateCsvLead}/>
      <div className="table-main-mobile">
        <Table2 onResults={handleResults} searchval={search} setLeadsPdf={setLeadsPdf} />
      </div>
